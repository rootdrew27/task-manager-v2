...
export function APIKeyValidationModal({children, setConfigStatus}: {  children: React.ReactNode, setConfigStatus: React.Dispatch<React.SetStateAction<boolean>>  }){
          ...
          <form onSubmit={handleSubmit} className="grid gap-4">
            <div className="grid gap-3">
              ...
              <div className="relative">
                ...
                >
                  {showPasswords.deepgram ? <EyeOffIcon className="h-4 w-4" /> : <EyeIcon className="h-4 w-4" />}
                </button>
              </div>
            </div>
            <div className="grid gap-3">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700"
                >
                  {showPasswords.openai ? <EyeOffIcon className="h-4 w-4" /> : <EyeIcon className="h-4 w-4" />}
                </button>
              </div>
            </div>
            <div className="grid gap-3">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700"
                >
                  {showPasswords.cartesia ? <EyeOffIcon className="h-4 w-4" /> : <EyeIcon className="h-4 w-4" />}
                </button>
              </div>
            </div>
            <button
